...
public interface CustomOperationObservable<T> {
     ...
     * returned by {@link Connection#queue(CustomOperationObservable)}
     * <p>
     ...
     */
    Observable<T> create(BluetoothGatt bluetoothGatt,
