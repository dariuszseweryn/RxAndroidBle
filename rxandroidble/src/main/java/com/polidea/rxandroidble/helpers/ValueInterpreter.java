 ...
 * {@link com.polidea.rxandroidble.RxBleConnection#readCharacteristic(UUID)} or
 * {@link com.polidea.rxandroidble.RxBleConnection#setupIndication(UUID)}. If the data in emitted byte arrays is stored using
