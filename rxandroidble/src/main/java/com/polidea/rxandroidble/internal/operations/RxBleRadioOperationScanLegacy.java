...
public class RxBleRadioOperationScanLegacy extends RxBleRadioOperation<RxBleInternalScanResultLegacy> {
        ...
        this.leScanCallback = new BluetoothAdapter.LeScanCallback() {
            ...
            public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
                ...
                if (!isFilterDefined || uuidUtil.extractUUIDs(scanRecord).containsAll(filterUuids)) {
                    RxBleRadioOperationScanLegacy.this.onNext(new RxBleInternalScanResultLegacy(device, rssi, scanRecord));
                }
            }
        };
    }
