...
public class UUIDUtil {
     ...
     */
    public RxBleScanRecord parseFromBytes(byte[] scanRecord) {
        if (scanRecord == null) {
            return null;
        }
        ...
        try {
            ...
            return new RxBleScanRecord(serviceUuids, manufacturerData, serviceData,
                    advertiseFlag, txPowerLevel, localName, scanRecord);
        } catch (Exception e) {
            RxBleLog.e(e, "unable to parse scan record: " + Arrays.toString(scanRecord));
            // As the record is invalid, ignore all the parsed results for this packet
            // and return an empty record with raw scanRecord bytes in results
            return new RxBleScanRecord(null, null, null, -1, Integer.MIN_VALUE, null, scanRecord);
        }
    }
